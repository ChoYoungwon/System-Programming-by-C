...
void cmd_help(int argc, char **argv)
{
    ...
    printf("ln [-s] <original> <link>    : Create a hard link from original to link.\n");
    ...
    printf("ps [-ef]               : Display a list of currently running processes.\n");
    printf("kill <pid>              : Terminate a process by its process ID (PID).\n");
	printf("chmod [mode] <target>    : Change the access permissions of a file or directory.\n");
